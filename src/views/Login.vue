    ...
    <b-row class="auth-inner m-0">
      ...
      <b-col lg="8" class="d-none d-lg-flex align-items-center p-5">
        <div class="w-100 d-lg-flex align-items-center justify-content-center px-5">
          <b-img fluid src="https://demos.pixinvent.com/vuexy-angular-admin-template/demo-1/assets/images/pages/login-v2.svg" alt="Login V2" />
        </div>
      </b-col>
      <!-- /Left Text-->
      ...
      this.$refs.loginValidation.validate().then(async success => {
        if (success) {
          ...
          try {
            ...
            const user = await useJwt.login(JSON.stringify(data))
            console.log(user.data.data)
            useJwt.setToken(user.data.token)
